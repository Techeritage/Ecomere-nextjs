  ...
  return (
    <div className="bg-[#008080] h-[75vh] flex flex-col md:flex-row px-[5%] md:px-[10%]">
      <div className="basis-1/2 flex flex-col justify-center">
        <h1 className={`${ptSans.className} text-3xl text-white md:text-5xl font-semibold w-[80%] mb-2 font-serif`}>
          Samsung Galaxy s23
        </h1>
        <p className="w-[60%] text-slate-200 text-[16px] md:text-lg mb-10 font-normal">
